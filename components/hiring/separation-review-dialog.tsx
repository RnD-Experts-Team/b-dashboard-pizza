...
export function SeparationReviewDialog({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      toast.success("Separation review submitted.");
      handleClose();
      onSuccess?.();
    } catch (err) {
      setError(
        err instanceof Error ? err.message : "Failed to submit separation review.",
      );
    } finally {
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Separation Review #{separationId}
          </DialogTitle>
          <DialogDescription>
            Submit a review for this separation request.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-between rounded-lg border p-3">
            <Label htmlFor="sep_is_completed" className="cursor-pointer">
              Is Completed
            </Label>
            <Switch
              id="sep_is_completed"
          ...
          <div className="space-y-2">
            <Label htmlFor="sep_review_notes">Notes</Label>
            <Textarea
              id="sep_review_notes"
              value={notes}
