...
/**
 * POST /api/hiring-management/[storeId]/separation-requests/employee/[employeeId]
 * Proxy → POST {HIRING_BASE_URL}/stores/{storeId}/separation-requests/employee/{employeeId}
...
export async function POST(
  ...
  try {
    ...
    const upstream = await fetch(
      `${HIRING_BASE_URL}/stores/${storeId}/separation-requests/employee/${employeeId}`,
      {
        method: "POST",
        headers: {
