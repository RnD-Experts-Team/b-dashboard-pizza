...
/**
 * POST /api/hiring-management/[storeId]/separation-requests/[separationId]/hiring-review
 */
export async function POST(
  ...
  try {
    ...
    const upstream = await fetch(
      `${HIRING_BASE_URL}/stores/${storeId}/separation-requests/${separationId}/hiring-review`,
      {
        method: "POST",
        headers: {
