...
/**
 * GET /api/hiring-management/[storeId]/create-employee-page
 * Proxy → GET {HIRING_BASE_URL}/stores/{storeId}/create-employee-page
 */
export async function GET(
  ...
  try {
    ...
    const upstream = await fetch(
      `${HIRING_BASE_URL}/stores/${storeId}/create-employee-page`,
      {
        method: "GET",
        headers: {
