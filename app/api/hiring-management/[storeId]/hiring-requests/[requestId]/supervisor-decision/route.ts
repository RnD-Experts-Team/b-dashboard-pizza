...
/**
 * POST /api/hiring-management/[storeId]/hiring-requests/[requestId]/supervisor-decision
 */
export async function POST(
  ...
  try {
    ...
    const upstream = await fetch(
      `${HIRING_BASE_URL}/stores/${storeId}/hiring-requests/${requestId}/supervisor-decision`,
      {
        method: "POST",
        headers: {
