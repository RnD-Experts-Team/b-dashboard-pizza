...
async function handleUpstreamError(response: Response) {
  ...
  if (response.status === 403) {
    return errorResponse("FORBIDDEN", "You do not have permission to delete this key.", 403);
  }
...
/* ────────────────────────────────────────────────────────────────────────── */
/*  DELETE /api/data/keys/[id]/force-delete — permanently delete a key      */
/* ────────────────────────────────────────────────────────────────────────── */
...
export async function DELETE(
  ...
  const targetUrl = `${DATA_BASE_URL}/engine/keys/${id}/force-delete`;
