...
/**
 * POST /api/screen-project/[storeId]/stations/[stationId]/media/uploads/complete-bulk
 * Body: { uploads: FinalizeUploadItem[] }
 * Proxy → POST {SCREEN_PROJECT_BASE_URL}/{storeId}/stations/{stationId}/media/uploads/complete-bulk
 */
export async function POST(
  ...
  try {
    ...
    const upstream = await fetch(
      `${SCREEN_PROJECT_BASE_URL}/${storeId}/stations/${stationId}/media/uploads/complete-bulk`,
      {
        method: "POST",
        headers: {
