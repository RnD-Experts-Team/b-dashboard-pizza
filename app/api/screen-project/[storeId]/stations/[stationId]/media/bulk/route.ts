...
/**
 * DELETE /api/screen-project/[storeId]/stations/[stationId]/media/bulk
 * Body: { ids: number[] }
 * Proxy → DELETE {SCREEN_PROJECT_BASE_URL}/{storeId}/stations/{stationId}/media/bulk
 */
export async function DELETE(
  ...
  try {
    ...
    const upstream = await fetch(
      `${SCREEN_PROJECT_BASE_URL}/${storeId}/stations/${stationId}/media/bulk`,
      {
        method: "DELETE",
        headers: {
