...
/**
 * POST /api/v1/milestone-gift-questions/[questionId]/options → add an option
 * Proxy → POST {HIRING_BASE_URL}/v1/milestone-gift-questions/{questionId}/options
 */
export async function POST(
  ...
  try {
    ...
    const upstream = await fetch(
      `${HIRING_BASE_URL}/v1/milestone-gift-questions/${questionId}/options`,
      {
        method: "POST",
        headers: {
