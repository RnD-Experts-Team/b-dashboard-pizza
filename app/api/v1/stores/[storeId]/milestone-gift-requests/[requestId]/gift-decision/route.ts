...
/**
 * POST /api/v1/stores/[storeId]/milestone-gift-requests/[requestId]/gift-decision
 * Proxy → POST {HIRING_BASE_URL}/v1/stores/{storeId}/milestone-gift-requests/{requestId}/gift-decision
 */
export async function POST(
  ...
  try {
    ...
    const upstream = await fetch(
      `${HIRING_BASE_URL}/v1/stores/${encodeURIComponent(storeId)}/milestone-gift-requests/${requestId}/gift-decision`,
      {
        method: "POST",
        headers: {
