...
/**
 * POST /api/v1/stores/[storeId]/milestone-gift-requests
 * Proxy → POST {HIRING_BASE_URL}/v1/stores/{storeId}/milestone-gift-requests
 */
export async function POST(
  ...
  try {
    ...
    const upstream = await fetch(
      `${HIRING_BASE_URL}/v1/stores/${encodeURIComponent(storeId)}/milestone-gift-requests`,
      {
        method: "POST",
        headers: {
