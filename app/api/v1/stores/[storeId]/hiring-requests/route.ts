...
/**
 * POST /api/v1/stores/[storeId]/hiring-requests
 * Proxy → POST {HIRING_BASE_URL}/v1/stores/{storeId}/hiring-requests
 */
export async function POST(
  ...
  try {
    ...
    const upstream = await fetch(
      `${HIRING_BASE_URL}/v1/stores/${encodeURIComponent(storeId)}/hiring-requests`,
      {
        method: "POST",
        headers: {
